...
use crate::{AccountId32, DilithiumMultiSig, Falcon512MultiSig, Falcon1024MultiSig};
//use crate::{AccountId32, Falcon512MultiSig};
//use crate::{AccountId32, Falcon1024MultiSig};
...
impl IdentifyAccount for sp_core::falcon512::Public {
	type AccountId = AccountId32;
...
impl IdentifyAccount for sp_core::falcon1024::Public {
	type AccountId = AccountId32;
...
impl Verify for Falcon512MultiSig {
    type Signer = sp_core::falcon512::Public;
    ...
    fn verify<L: Lazy<[u8]>>(&self, mut msg: L, signer: &AccountId32) -> bool {
        ...
        // Verify signature using Falcon512 backend verify.
        <sp_core::falcon512::Pair as sp_core::crypto::Pair>::verify(
            &self.signature,
            msg.get(),
            &self.public,
        )
...
impl Verify for Falcon1024MultiSig {
    type Signer = sp_core::falcon1024::Public;
    ...
    fn verify<L: Lazy<[u8]>>(&self, mut msg: L, signer: &AccountId32) -> bool {
        ...
        // Verify signature using Falcon1024 backend verify.
        <sp_core::falcon1024::Pair as sp_core::crypto::Pair>::verify(
            &self.signature,
            msg.get(),
            &self.public,
        )
