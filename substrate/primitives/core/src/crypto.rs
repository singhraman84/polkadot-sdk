...
impl From<crate::falcon512::Public> for AccountId32 {
    fn from(pk: crate::falcon512::Public) -> Self {
        sp_crypto_hashing::blake2_256(pk.as_ref()).into()
    }
}

impl From<crate::falcon1024::Public> for AccountId32 {
    fn from(pk: crate::falcon1024::Public) -> Self {
        sp_crypto_hashing::blake2_256(pk.as_ref()).into()
    }
}
...
pub mod key_types {
	...
	// Crypto ID for Falcon512
	pub const FALCON512: KeyTypeId = KeyTypeId(*b"f512"); 
	//Crypto ID for Falcon1024
	pub const FALCON1024: KeyTypeId = KeyTypeId(*b"f124");  
}
