...
pub const PUBLIC_KEY_LEN: usize = 1793;   // This is lengh/size of Public key in Falcon1024
pub const SIGNATURE_LEN: usize = 1577;    
// The standard typical signature size of Falcon1024 is 1280 bytes. But falcon-rs crate generate 1577 bytes of signature
pub const SEED_LEN: usize = 32;

pub const CRYPTO_ID: CryptoTypeId = CryptoTypeId(*b"f124");  //This is 4 Byte crypto ID for newly added Falcon1024 DSA
...
impl TraitPair for Pair {
    ...
    fn from_seed_slice(seed: &[u8]) -> Result<Self, SecretStringError> {
        ...
        let kp = FnDsaKeyPair::generate_deterministic(&s, 10)
...
mod tests {
    ...
    fn seed_pair_should_sign_and_verify1024() {
    ...
    fn deterministic_keypair_should_match1024() {
        let seed: Seed = *b"12345678901234567890123456789012";
    ...
    fn signatures_should_not_be_equal1024() {
        let seed: Seed = *b"12345678901234567890123456789012";
    ...
    fn signature_length_is_constant1024() {
        let seed: Seed = *b"12345678901234567890123456789012";
        let pair = Pair::from_seed(&seed);
    ...
    fn public_key_length_is_constant1024() {
        let seed: Seed = *b"12345678901234567890123456789012";
        let pair = Pair::from_seed(&seed);
